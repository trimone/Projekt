========================================================================
    ANWENDUNG: VorlageWindowsForm-Projektübersicht
========================================================================

Diese VorlageWindowsForm-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre VorlageWindowsForm-Anwendung besteht.

VorlageWindowsForm.vcxproj
...
VorlageWindowsForm.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "VorlageWindowsForm.pch und eine 
